      ...
      <div className="w-full md:w-1/2 flex flex-col items-center justify-center p-6 sm:p-12 lg:p-16 relative overflow-y-auto min-h-screen">
        <div className="w-full max-w-md animate-fade-in relative z-10">
            ...
            {portalOptions.map((portal) => (
              ...
              >
                <div className="relative z-10 flex items-center justify-between gap-4 sm:gap-5">
                  ...
                  <ArrowRightIcon className="w-4 h-4 text-slate-400 group-hover:translate-x-1 transition-all duration-300" />
                </div>
              </Link>
            ))}
          </div>
          ...
          <div className="mt-12 text-center md:text-left text-sm text-slate-400">
            <p>
              &copy; {new Date().getFullYear()} Elnathan. All right reserved.
            </p>
          </div>
        </div>
      </div>
